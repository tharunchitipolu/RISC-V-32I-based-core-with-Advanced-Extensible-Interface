...
reg master_en, clk, rst, fill_random, fill_values,sim_time;

pipelined processor(.master_en(master_en),  .clk(clk), .rst(rst), .fill_random(fill_random),.fill_values(fill_values));
