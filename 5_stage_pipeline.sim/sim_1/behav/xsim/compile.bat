...
REM
REM Generated by Vivado on Sat May 28 10:30:19 +0530 2022
...
echo "xvlog --incr --relax -prj pipeline_trial1_vlog.prj"
call xvlog  --incr --relax -prj pipeline_trial1_vlog.prj -log xvlog.log
